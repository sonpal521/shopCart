                ...
                <div className="cart-wrapper ">
                    ...
                    <div className="price-details d-flex flex-column" id="priceDetails">
                        ...
                        <div className="price-details-btn-group">
                            <Button className="continue-shopping-btn  text-decoration-none" color="info"> Continue Shopping</Button>
                           
                            <Button className="checkout-btn text-decoration-none" color="primary" >Checkout</Button>
